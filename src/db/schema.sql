...
ALTER TABLE brands ADD COLUMN IF NOT EXISTS h1_title VARCHAR(255);
ALTER TABLE brands ADD COLUMN IF NOT EXISTS seo_content TEXT;
...
ALTER TABLE products ADD COLUMN IF NOT EXISTS main_image_alt VARCHAR(255);
...
-- Force add or update phone column if table already exists
ALTER TABLE offices ADD COLUMN IF NOT EXISTS phone TEXT;
...
ALTER TABLE subscribers ADD COLUMN IF NOT EXISTS phone VARCHAR(255);
...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS commune VARCHAR(255);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS delivery_company VARCHAR(50);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS stop_desk BOOLEAN;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS office_id VARCHAR(255);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS office_name VARCHAR(255);
ALTER TABLE orders ALTER COLUMN office_id TYPE VARCHAR(255);
