    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1">
          {loading ? (
            <div className="mb-8 rounded-xl overflow-hidden shadow-md relative w-full aspect-[2/1] md:aspect-[16/5] bg-gray-200 animate-pulse"></div>
          ) : categoryImage ? (
            <div className="mb-8 rounded-xl overflow-hidden shadow-md relative w-full aspect-[2/1] md:aspect-[16/5] bg-gray-100 flex items-center justify-center">
              <img 
                src={categoryImage} 
                alt={categoryName} 
