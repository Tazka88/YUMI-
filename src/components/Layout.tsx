          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/" className="flex items-center hover:opacity-90 transition-opacity" aria-label="ZORANDO Accueil">
                {settings.site_logo ? (
                  <img src={settings.site_logo} alt="ZORANDO Logo" className="h-8 md:h-10 w-auto object-contain" fetchPriority="high" loading="eager" />
                ) : (
                  <svg width="180" height="36" viewBox="0 0 180 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-auto">
                    ...
                    <text x="38" y="27" fontFamily="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" fontSize="26" fontWeight="900" fill="white" letterSpacing="-0.04em">ZORANDO<tspan fill="#FFD8A8">.</tspan></text>
                  </svg>
                )}
              </Link>
            </div>
