...
router.post('/admin/blog/posts', authenticate, async (req, res) => {
  try {
    let { category_id, title, slug, excerpt, content, image_url, status, seo_title, seo_description, image_1_url, image_1_alt, image_2_url, image_2_alt, image_3_url, image_3_alt, main_image_alt } = req.body;
