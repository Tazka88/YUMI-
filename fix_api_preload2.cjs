...
`; // I'll just use indexOf and replace the whole block until the end of the if(firstSlide)
...
`;
  ...
  console.log("Could not find markers in api/index.ts", startIdx, endIdx);
}
