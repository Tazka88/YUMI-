...
router.post('/admin/products', authenticate, async (req, res) => {
  const { category_id, subcategory_id, sub_subcategory_id, brand_id, brand_name, name, slug, description, price, promo_price, stock, image, video_url, is_popular, is_best_seller, is_new, is_recommended, is_fast_delivery, is_active, images, features, key_points } = req.body;
  
  try {
    const productId = await sql.begin(async (sql: any) => {
      const [info] = await sql`
        INSERT INTO products (category_id, subcategory_id, sub_subcategory_id, brand_id, brand_name, name, slug, description, price, promo_price, stock, image, video_url, is_popular, is_best_seller, is_new, is_recommended, is_fast_delivery, is_active, features, key_points)
